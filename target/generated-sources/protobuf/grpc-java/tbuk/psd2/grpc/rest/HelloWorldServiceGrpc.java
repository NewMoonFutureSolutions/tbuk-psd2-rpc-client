...
public final class HelloWorldServiceGrpc {
  ...
  public static final String SERVICE_NAME = "tbuk.psd2.grpc.rest.HelloWorldService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<tbuk.psd2.grpc.rest.HelloWorld.Person,
      tbuk.psd2.grpc.rest.HelloWorld.Greeting> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = tbuk.psd2.grpc.rest.HelloWorld.Person.class,
      responseType = tbuk.psd2.grpc.rest.HelloWorld.Greeting.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<tbuk.psd2.grpc.rest.HelloWorld.Person,
      tbuk.psd2.grpc.rest.HelloWorld.Greeting> getSayHelloMethod() {
    io.grpc.MethodDescriptor<tbuk.psd2.grpc.rest.HelloWorld.Person, tbuk.psd2.grpc.rest.HelloWorld.Greeting> getSayHelloMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getSayHelloMethod = HelloWorldServiceGrpc.getSayHelloMethod) == null) {
          HelloWorldServiceGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<tbuk.psd2.grpc.rest.HelloWorld.Person, tbuk.psd2.grpc.rest.HelloWorld.Greeting>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "tbuk.psd2.grpc.rest.HelloWorldService", "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  tbuk.psd2.grpc.rest.HelloWorld.Person.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  tbuk.psd2.grpc.rest.HelloWorld.Greeting.getDefaultInstance()))
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                tbuk.psd2.grpc.rest.HelloWorld.Person,
                tbuk.psd2.grpc.rest.HelloWorld.Greeting>(
  ...
  public static final class HelloWorldServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloWorldServiceBlockingStub> {
    ...
    /**
     */
    public tbuk.psd2.grpc.rest.HelloWorld.Greeting sayHello(tbuk.psd2.grpc.rest.HelloWorld.Person request) {
  ...
  public static final class HelloWorldServiceFutureStub extends io.grpc.stub.AbstractStub<HelloWorldServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<tbuk.psd2.grpc.rest.HelloWorld.Greeting> sayHello(
        tbuk.psd2.grpc.rest.HelloWorld.Person request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((tbuk.psd2.grpc.rest.HelloWorld.Person) request,
              (io.grpc.stub.StreamObserver<tbuk.psd2.grpc.rest.HelloWorld.Greeting>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return tbuk.psd2.grpc.rest.HelloWorld.getDescriptor();
    }
